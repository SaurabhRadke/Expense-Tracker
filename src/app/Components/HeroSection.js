...
export default function HeroSection({login,HandelLogin,authenticated}){
    ...
    return(
        <div className=" w-full h-full  flex gap-4 justify-center items-center">
            ...
            <Link href={authenticated?"/Dashboard":"/"}><button id="button-hero" className=" bg-black    overflow-hidden text-nowrap px-5 py-3 text-white font-medium rounded-md text-sm sm:text-xl">Get started Now</button></Link>
            </div>
